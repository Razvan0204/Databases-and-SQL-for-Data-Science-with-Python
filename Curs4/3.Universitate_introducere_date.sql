...
INSERT INTO profesor SET nume = 'Popescu', prenume = 'Gica', 
	data_nasterii = '1964-02-01', grad = 1, adresa_idadresa = 1;
SELECT * FROM profesor;

INSERT INTO profesor 	(nume, prenume, adresa_idadresa, data_nasterii, grad)
...
INSERT INTO curs SET titlu = 'MySQL', an=1, semestru=1, credite=5; 
INSERT INTO curs SET titlu = 'Python Fundamentals', an=1, semestru=1, credite=8; 
INSERT INTO curs SET titlu = 'HTML', an=1, semestru=1, credite=6; 
